...
function hithean_product_nutrition_label_enqueue_front_assets(): void
{
    ...
    $css = '..product-nutrition-label__stage{position:relative;padding:20px58px;touch-action:pan-y}.product-nutrition-label{margin:18px 0!important;text-align:left;display:flex;justify-content:center;}@media(min-width:769px){.product-nutrition-label{justify-content:left;}}.product-nutrition-label__trigger{display:inline-flex;align-items:center;justify-content:center;gap:8px;box-sizing:border-box;width:235px;max-width:100%;min-height:44px;line-height:1.25;text-align:center;white-space:normal!important;overflow-wrap:anywhere;cursor:pointer;padding:0 10px;}.product-nutrition-label__triggeri{flex:00auto;margin-right:0}.product-nutrition-label__modal[hidden]{display:none}.product-nutrition-label__modal{position:fixed;z-index:999999;inset:0;display:grid;place-items:center;padding:20px}.product-nutrition-label__backdrop{position:absolute;inset:0;background:rgba(0,0,0,.68)}.product-nutrition-label__dialog{position:relative;display:grid;gap:14px;width:min(100%,900px);max-height:calc(100vh-40px);padding:44px20px20px;overflow:auto;border-radius:12px;background:#fff;box-shadow:020px60pxrgba(0,0,0,.32)}.product-nutrition-label__close{position:absolute;top:8px;right:10px;width:34px;height:34px;border:0;border-radius:50%;background:#f1f1f1;color:#111;font-size:28px;line-height:1;cursor:pointer}.product-nutrition-label__nav{position:absolute;top:50%;z-index:2;display:grid;place-items:center;width:42px;height:42px;border:0;border-radius:50%;background:rgba(0,0,0,.58);color:#fff;font-size:36px;line-height:1;transform:translateY(-50%);cursor:pointer}.product-nutrition-label__nav--prev{left:8px}.product-nutrition-label__nav--next{right:8px}.product-nutrition-label__image{margin:0;text-align:center}.product-nutrition-label__imageimg{display:block;width:auto;max-width:100%;max-height:70vh;margin:auto}.product-nutrition-label__imagefigcaption{margin-top:8px;display:inline-block;padding:4px10px;background:rgba(0,0,0,.55);color:#fff;font-weight:600;text-shadow:01px3pxrgba(0,0,0,.65)}.product-nutrition-label__thumbs{display:flex;justify-content:center;gap:8px;overflow-x:auto;padding:2px}.product-nutrition-label__thumb{flex:0064px;padding:2px;border:2pxsolidtransparent;border-radius:6px;background:transparent;cursor:pointer}.product-nutrition-label__thumb.is-active{border-color:#111}.product-nutrition-label__thumbimg{display:block;width:56px;height:56px;object-fit:cover}@media(max-width:600px){.product-nutrition-label{text-align:center;}.product-nutrition-label__trigger{width:235px;padding:10px12px}.product-nutrition-label__modal{padding:10px}.product-nutrition-label__dialog{max-height:calc(100vh-20px);padding:42px12px12px}.product-nutrition-label__stage{padding:20px44px}.product-nutrition-label__nav{width:36px;height:36px;font-size:30px}.product-nutrition-label__nav--prev{left:0}.product-nutrition-label__nav--next{right:0}}';
